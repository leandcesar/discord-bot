...
class EmoteEmbed(disnake.Embed):
    def __init__(
        ...
        *,
        ...
        title = inter.bot.localized(key="COMMAND_EMOTE_ADD_TITLE", locale=inter.locale)
...
class EmoteError(disnake.Embed):
    def __init__(
        ...
        *,
        ...
        title = inter.bot.localized(key="COMMAND_EMOTE_ADD_ERR_TITLE", locale=inter.locale)
        title = title.format(name)

        match err_enum:
            case EmoteErrorEnum.WITHOUT_PERMISSION:
                gif_error = NO_PERM_GIF
                description = inter.bot.localized(key="COMMAND_EMOTE_ADD_ERR_WITHOUT_PERM", locale=inter.locale)

            case EmoteErrorEnum.LARGE_IMAGE:
                gif_error = LARGE_GIF
                description = inter.bot.localized(
                    key="COMMAND_EMOTE_ADD_ERR_LARGE_IMAGE", locale=inter.locale
